...
//    // NOUVEAU : On stocke les chemins persistants ici
//    private List<Chemin>  lstChemins;
...
//        this.lstChemins = new ArrayList<Chemin>(); // On vide la liste des chemins
//        this.positionDeterminee = false; // On force le recalcul au prochain paint
...
//        for (Classe c : this.lstClasse) 
//        {
//            // Taille 0,0 au début, sera corrigée par paintComponent
//            Rectangle rect = new Rectangle(x, y, 0, 0);
//            this.mapClasseRectangle.put(c, rect);
...
//        // 1. Dessin des classes (cela met à jour la taille des rectangles)
//        for (Classe classe : this.lstClasse)
//            this.dessinerClasse(g2, classe);
        
//        // 2. Si c'est le premier affichage, on place tout et on crée les chemins
//        if (!this.positionDeterminee) 
//        {
//            this.determinerPositions(); // C'est ici que la magie opère
//            this.positionDeterminee = true;
//            this.repaint(); // On redessine une fois pour afficher les flèches
//            return;
//        }

//        // 3. Dessin des liaisons (via les Chemins intelligents)
...
//    /**
//     * Cette méthode est le Cerveau. Elle place les boites ET crée les connexions intelligentes.
//     */
//    private void determinerPositions()
//    {
//        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
...
//        // 1. Placement simple des rectangles (Grille)
//        for (Rectangle rect : this.mapClasseRectangle.values()) 
//        {
//            if (xCourant + rect.getTailleX() > screenSize.width - 100 && xCourant > 50) 
//            {
...
//            // Important: On met à jour les connexions quand on déplace
//            // (Même si pour l'instant la liste est vide, c'est une bonne pratique)
//            // rect.updateConnexions(); 
...
//        // 2. CRÉATION DES CHEMINS INTELLIGENTS
//        this.lstChemins.clear();
...
//            if (r1 != null && r2 != null) 
//            {
//                // Points temporaires (centres)
//                Point p1 = new Point(r1.getCentreX(), r1.getCentreY());
//                Point p2 = new Point(r2.getCentreX(), r2.getCentreY());
                
//                // Création du Chemin
//                // Note : Assurez-vous que le constructeur de Chemin correspond bien à celui-ci
//                Chemin chemin = new Chemin(p1, p2, "ASSOCIATION", 
//                                           this.mapClasseRectangle, l.getFromClass(), l.getToClass());
                
//                // Détermination de la zone (Haut, Bas, Gauche, Droite)
//                char zoneR1 = this.getZone(r1, r2);
//                char zoneR2 = this.zoneInverse(zoneR1);

//                // ENREGISTREMENT DANS LES RECTANGLES (C'est ça qui active la répartition !)
//                r1.addPos(zoneR1, chemin);
//                r2.addPos(zoneR2, chemin);
                
//                // Force le calcul immédiat des coordonnées précises
//                r1.repartirPointsLiaison(zoneR1);
//                r2.repartirPointsLiaison(zoneR2);
...
//    // =========================================================================
//    //                        MÉTHODES UTILITAIRES DE GÉOMÉTRIE
//    // =========================================================================
...
//    //                        DESSIN D'UNE CLASSE
//    // =========================================================================
//    // (Cette partie n'a pas changé, elle sert juste à dessiner la boite)
...
//        // Mise à jour de la taille dans le modèle
//        rect.setTailleX(largeurRect);
//        rect.setTailleY(hauteurTotale);
//    }
...
//            if (isStatic) souligner(g2, x + PADDING_X, y + fm.getAscent(), fm.stringWidth(s));
//            y += hLigne + INTERLIGNE;
//        }
//        if (showPoints) g2.drawString("...", x + PADDING_X, y + fm.getAscent());
//    }
...
//    {
//        int w = fm.stringWidth(c.getNom());
//        if (c.isInterface() || c.isAbstract()) w = Math.max(w, fm.stringWidth("<<Interface>>"));
//        return w;
//    }
...
//    {
//        int h = PADDING_Y * 2 + hLigne; 
//        if (c.isInterface() || (c.isAbstract() && !c.isInterface())) h += hLigne; 
//        return h;
//    }
...
//    {
//        int nbLignesReelles = avecPoints ? nbLignes + 1 : nbLignes;
//        if (nbLignesReelles == 0) return PADDING_Y * 2 + INTERLIGNE;
//        return (PADDING_Y * 2) + (nbLignesReelles * hLigne) + ((nbLignesReelles - 1) * INTERLIGNE);
//    }
