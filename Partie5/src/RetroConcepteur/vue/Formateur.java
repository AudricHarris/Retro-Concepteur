...
public class Formateur
{
	...
	public Formateur(Controller controller)
	{
	...
	public String afficherClasse ()
	{
		...
		{
			int maxLargeur = Formateur.TAILLE_MIN;
	...
	public String getBlocAttribut  (Classe classe, int tailleAttributMax) 
	{
		...
		for (Attribut att : classe.getLstAttribut())
		{
			...
			ligne += Formateur.getSigneVisibilite(att.getVisibilite()) + " ";
	...
	public String getBlocMethode (Classe classe, int tailleMethodeMax)
	{
		...
		for (Methode meth : classe.getLstMethode())
		{
			...
			ligne += Formateur.getSigneVisibilite(meth.getVisibilite()) + " " ;
	...
	public String getPlusGrandeLigne(String bloc)
	{
		String ligneMax="";
		String ligne;
	...
	{
		if ( this.getPlusGrandeLigne(blocMeth).length() > this.getPlusGrandeLigne(blocMeth).length() )
			return this.getPlusGrandeLigne(blocMeth);
		else
			return this.getPlusGrandeLigne(blocMeth);
	}
